                ...
                <div className="row">
                    <div className="col-lg-4">
                        <div className="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img className="img-fluid rounded-circle mb-3" src="public/Images/testimonials-1.jpg" alt="..."/>
                            <h5>Margaret E.</h5>
                    ...
                    <div className="col-lg-4">
                        <div className="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img className="img-fluid rounded-circle mb-3" src="public/Images/testimonials-3.jpg" alt="..."/>
                            <h5>Sarah W.</h5>
